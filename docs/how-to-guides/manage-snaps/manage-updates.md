...
The refresh rate is freely configurable, and can be set to any duration above a lower bound of once every 20 minutes. There are four {ref}`system-wide options <how-to-guides-manage-snaps-set-system-options>` that manage how updates are handled:
