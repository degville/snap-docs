...
Snap supports a set of system-wide options that allow you to customise your snap environment. See {ref}`System options <how-to-guides-manage-snaps-set-system-options>` for which options are supported.
