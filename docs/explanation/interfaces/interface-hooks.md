...
> ⓘ An interface consists of a connection between a plug and a slot. The slot is the provider of the interface while the plug is the consumer, and a slot can support multiple plug connections. For more details, see [Interface management](/snap-how-to-guides/work-with-snaps/connect-interfaces).
