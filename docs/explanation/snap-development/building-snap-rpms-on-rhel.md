...
Snap is  currently available for  [Red Hat Enterprise Linux (RHEL) 8](https://www.redhat.com/en/enterprise-linux-8) and RHEL 7.6+. See {ref}`Installing snap on Red Hat Enterprise Linux (RHEL) <interfaces-installing-snap-on-red-hat>` for installation instructions.
