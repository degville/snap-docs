...
See [the joystick interface](https://forum.snapcraft.io/t/the-joystick-interface/7849) and {ref}`the raw-usb interface <interfaces-raw-usb-interface>` for potential alternatives. 
