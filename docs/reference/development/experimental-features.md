...
If an experimental feature is considered unstable or likely to change, they are demarcated by an experimental feature flag, such as the following for [Quota groups](/how-to-guides/manage-snaps/use-resource-quotas).
...
| :-------------------------------------------------------------------------------- | :---------------------- | :----------------- | :------------------------------------------------------------------------------------------- |
| [Layouts](/reference/development/experimental-features)                                                                | Jun 2018 (snapd 2.33)   | YES                | Widely used by graphical snaps as they depend on files in the gnome content snaps.           |
| [Hotplug support](/explanation/how-snaps-work/hotplug-support)                                                       | Jul 2018 (snapd 2.34)   | NO                 | Currently only serial ports are supported (serial-port interface).                           |
| [Parallel installs](/explanation/how-snaps-work/parallel-installs)                                                      | Jun 2018 (snapd 2.34)   | NO                 | Layouts are not working properly with parallel installs due problems with persistent mounts. |
...
| [Refresh app awareness](/explanation/how-snaps-work/refresh-awareness)                                                 | Mar 2019 (snapd 2.38)   | YES                | There are some bugs that need to be addressed.                                               |
...
| [The dbus interface](/reference/interfaces/dbus-interface)                                                     | Aug 2020 (snapd 2.46)   | YES                | dbus-activation is now supported.                                                            |
...
| [Disk space awareness](/how-to-guides/manage-snaps/disk-space-awareness)                                                  | Sept 2020 (snapd 2.47)  | NO                 | Needs better testing.                                                                        |
...
| [Quota groups](/how-to-guides/manage-snaps/use-resource-quotas)                                                          | May 2021 (snapd 2.51)   | NO                 | Memory, CPU and thread quotas have moved out of experimental.                                |
